...
leftarm = pygame.image.load("LABS/Lab_7/images/leftarm.png")
rightarm = pygame.image.load("LABS/Lab_7/images/rightarm.png")
mainclock = pygame.transform.scale(pygame.image.load("LABS/Lab_7/images/clock.png"), (800, 600))
