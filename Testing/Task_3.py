...
def reset_game():
    global SPEED, HEALTH, COINS, c1, c2, c3, c4, c5, background_y
...
while True:
    ...
    health_text = font_small.render(str(HEALTH), True, BLACK)
    health_name = font_small.render("HEALTH", True, BLACK)
    screen.blit(health_text, (100, 10))
    screen.blit(health_name, (10, 10))

    coins = font_small.render(str(COINS), True, BLACK)
    coins_name = font_small.render("COINS", True, BLACK)
    screen.blit(coins_name, (290, 10))
